      ...
      <v-speed-dial
         ...
         <v-dialog
            ...
            >
                 <v-card>
                   <v-card-title>
                     <span class="blue--text text-h5">Kudo</span>
                   </v-card-title>
                   <v-card-text>
         ...
         <v-bottom-navigation fixed>
              <v-tooltip top>
                  ...
                  <span>Go to observations section</span>
              </v-tooltip>
              <v-tooltip top>
                  <template v-slot:activator="{ on, attrs }">
                  ...
                  <span>Go to action plan section</span>
              </v-tooltip>
              <v-tooltip top>
                  <template v-slot:activator="{ on, attrs }">
                  <v-btn href="#kudo" v-bind="attrs" v-on="on">
                      <v-badge content="3">
                          <v-icon>mdi-thumb-up</v-icon>
                      </v-badge>
                  </v-btn>
                  </template>
                  <span>Go to kudo section</span>
              </v-tooltip>
         </v-bottom-navigation>
    </v-container>
</template>
